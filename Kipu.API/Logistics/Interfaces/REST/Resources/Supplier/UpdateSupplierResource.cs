...
/// <summary>
/// Request payload to update an existing supplier (full replacement)
/// </summary>
/// <param name="Ruc">The supplier's tax identification number (RUC) - 11 digits</param>
...
[SwaggerSchema(Description = "Request payload to update an existing supplier")]
